...
export default function ClaudePage() {
  const [systemPrompt, setSystemPrompt] = useState(
    "You are a helpful business assistant. Answer questions clearly and concisely."
  );
  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Claude Assistant</h1>
        <p className="text-sm text-slate-400 mt-1">Streaming chat with Claude — system prompt editable</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          rows={2}
          className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-sm text-slate-300 focus:outline-none focus:border-slate-500 resize-none"
        />
      </div>

      <div className="space-y-4 mb-6 min-h-[260px]">
        ...
        {isLoading && (
          <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 mr-8">
            <div className="text-xs text-slate-500 mb-1 uppercase tracking-widest">claude</div>
